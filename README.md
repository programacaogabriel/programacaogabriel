...
Um apaixonado por tecnologia que evoluiu ainda mais dentro da área de qualidade. Atuo como QA com experiência prática em projetos reais, incluindo Bradesco e Vivo, e sigo me especializando em testes manuais e automação com as ferramentas mais usadas no mercado atual.

Tenho formação em Gestão da Tecnologia da Educação e em Análise e Desenvolvimento de Sistemas. Hoje estou focado no aprendizado contínuo de Java, JavaScript, Postman, SQL, Cypress, Selenium e boas práticas modernas de QA.
